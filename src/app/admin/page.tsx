...
export default function AdminPage() {
  ...
  // Poll for data every 5 seconds to satisfy "update automatically" requirement
  useEffect(() => {
    setIsClient(true);
  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-6" role="alert">
        <p className="font-bold">Live Data Mode</p>
        <p>The dashboard is automatically syncing with the server. (Status: {isLoading ? "Syncing..." : "Connected"})</p>
        <p className="text-sm mt-1">Note: In serverless environments (Vercel), data may be volatile. Use "Import" for backups.</p>
      </div>
